...
DEFAULT_CONFIG = {
    ...
    "quiet_archive_handoff_enabled": False,
    "quiet_archive_handoff_target": "",
...
def _sanitize_config(saved):
    ...
    for key in (
        ...
        "resource_backup_enabled", "quiet_archive_handoff_enabled",
    ...
    int_ranges = {
        ...
        "monitor_ai_timeout_seconds": (10, 300),
